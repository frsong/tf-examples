...
* `mnist_cnn.py` implements a CNN based on the code from https://www.tensorflow.org/get_started/mnist/pros. Includes code for printing all trainable variables and counting the number of parameters in the model, which I find useful to know.
